...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function startGame() {
     ...
     function moveOutcomes() {
        ...
        //deals with snale hitting border and snake hitting self
        if (
     ...
     function randomApple() {
         ...
         } while (squares[appleIndex].classList.contains('snake')); //making sure apples don't appear om the snake
    ...
    function control(e) {
        ...
        if (e.keyCode === 39) {
            ...
            direction = +width; // down, the snake head will instantly appear in the div ten divs from whre you are now
        }
    }
